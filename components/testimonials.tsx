                ...
                <div className="mx-auto max-w-3xl text-center">
                    <blockquote>
                        <p className="text-lg font-semibold sm:text-xl md:text-3xl">
                            &ldquo;Most tools stop being useful the second the connection drops. <FieldMidText className="text-lg sm:text-xl md:text-3xl" /> was built for teams that do not have that luxury.&rdquo;
                        </p>
